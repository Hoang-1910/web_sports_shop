...
<div class="container mx-auto px-4">
    <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl font-bold text-purple-700 mb-6">Thêm khuyến mãi</h2>
        
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <form method="POST" action="{{ route('admin.promotions.store') }}" class="p-8">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" 
                           ...
                           required value="{{ old('name') }}" placeholder="Nhập tên chương trình khuyến mãi">
                    @error('name')
                ...
                <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="discount_value" 
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-purple-400 focus:ring focus:ring-purple-100 transition duration-200" 
                               required min="0" value="{{ old('discount_value') }}" placeholder="0">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="type" id="promotion-type" 
                        ...
                        <option value="global" {{ old('type') == 'global' ? 'selected' : '' }}>Toàn shop</option>
                        ...
                        <option value="supplier" {{ old('type') == 'supplier' ? 'selected' : '' }}>Nhà cung cấp</option>
                    </select>
                </div>
                ...
                <div class="mb-8">
                    <label class="inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-gray-700 font-semibold">Kích hoạt ngay</span>
                    </label>
                </div>
